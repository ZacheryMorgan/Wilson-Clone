  ...
  return (
    <div className='relative' >
      ...
      <div className="quilt-content text-left absolute bottom-0 left-0 p-3">
        ...
        <p className='text-sm text-white pb-3' >Save when you buy a <br /> performance top and bottom together</p>
        <button className='border-[#131b23] border-2 bg-white text-[#131b23] hover:bg-[#131b23] hover:text-white
