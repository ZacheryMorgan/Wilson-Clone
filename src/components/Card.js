  ...
  return (
    <div className="card-wrapper  shadow-md shadow-black rounded-sm">
      <div className="img-wrapper relative overflow-hidden">
        ...
        />
        <p
          className='name absolute bottom-0 bg-white px-3 py-1 rounded-sm -translate-x-1/2 left-1/2 font-bold'
        >
          {data.name}
        </p>
      </div>
      ...
      >
        ...
        <input
          className='w-14'
          type="number" name="" id="" placeholder='0' value={data.quantity} min='0'
